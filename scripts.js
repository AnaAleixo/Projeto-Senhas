...
function getInfoBasedOnScore(){
    if(totalScore() < 7){
        var score_info = "Você precisa tomar mais cuidado com a segurança de suas senhas! Procure a TI e peça orientação!";
    } else if(totalScore() > 7){
        var score_info = "Parabéns! Você é cuidadoso(a) com a segurança de suas senhas!"
    }
